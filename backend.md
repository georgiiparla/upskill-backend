...
class DashboardController < ApplicationController
  ...
  get '/' do
    ...
    # --- Team Stats (Mock Data) ---
    team_stats = {
      quests_completed_week: 12,
      feedback_given_week: 34
    }
    
    # --- NEW: Mock Personal Stats ---
    # Using mock data as requested until the logic is implemented.
    personal_stats = {
        feedback_given_total: 8,
        points_total: 1250,
        quests_completed_total: 5 # Added mock data for personal quests
    }
    ...
    json({
      ...
      personalStats: personal_stats # Now sends the mock personal data
    })
  end
end
```
